...
xl:px-10 max-lg:py-4"
      >
        ...
        <a
          href="#signup"
          className="cursor-not-allowed button hidden mr-8 text-n-1/50 transition-colors hover:text-n-1 lg:block"
        >
          New account
        </a>
        <Button classname="cursor-not-allowed hidden lg:flex" href="#login">
          Sign in
        </Button>
