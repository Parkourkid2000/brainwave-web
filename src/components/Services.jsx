          ...
          >
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <ul className="body-2">
                {brainwaveServices.map((item, index) => (
                  <li
                    key={index}
                    className="flex item-start py-4 border-t border-n-6"
                  >
            ...
            <Generating
              className="absolute left-4 right-4 bottom-4
                    border-n-1/10 border lg:left-1/2 lh-right-auto lg:bottom-8
                    lg:-translate-x-1/2 "
            />
          </div>
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            >
              ...
              >
                ...
                <p className="body-2 mb-[3rem] text-n-3">
                  Automatically enhance your photos unsing our AI app&apos;s
